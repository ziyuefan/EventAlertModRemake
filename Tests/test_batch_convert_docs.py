...
CONVERTER_PATH = PROJECT_ROOT / "Tools" / "batch_convert_docs.py"
...
class BatchConvertDocsTests(unittest.TestCase):
    ...
    def test_external_github_markdown_link_is_unchanged(self):
        source = (
            '<a href="https://github.com/ziyuefan/EventAlertMod_Remake/'
            'blob/main/Docs/26_FLOW_VALIDATION_FRAMEWORK.md">Docs</a>'
        )
