...
EAM.Constants = freeze({
    SCHEMA_VERSION = 6,
    PLAYER_RESOURCE_SCHEMA_VERSION = 4,
    ...
    AURA_CATALOG_SCOPE_SELF = "SELF",
    AURA_CATALOG_SCOPE_CROSS_CLASS = "CROSS_CLASS",
    AURA_FILTERS = freeze({
        HELPFUL = "HELPFUL",
        HARMFUL = "HARMFUL",
        PLAYER = "PLAYER",
    ...
    RETAIL_COMPATIBILITY_LABEL = "12.0.7 Legacy / XPTR",
