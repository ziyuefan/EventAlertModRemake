...
L.EAM_OPT_POS_AND_POWER_BTN = "設定"
...
L.EAM_OPT_ALLOW_ESC = "ESC 關閉提示圖示"
L.EAM_OPT_ALLOW_ESC_TIP = "在遊戲中按 ESC 鍵可快速隱藏畫面中央的所有提醒圖示（採用無損純透明度，不破壞冷卻預渲染，進入戰鬥或觸發新提示時自動恢復）。"
...
L.EAM_OPT_SWIPE_COLOR = "扇形顏色"
L.EAM_OPT_SWIPE_COLOR_TIP = "點擊開啟調色盤，自訂光環與冷卻圖示倒數扇形陰影遮罩的顏色（預設經典黑色陰影）"
...
L.EAM_OPT_CONFIRM_NON_CLASS_SPELL = "這個 SPELL ID 可能不是你的職業專屬，你仍要加入嗎？"
L.EAM_OPT_CONFIRM_TITLE = "跨職業法術確認"
L.EAM_OPT_CONFIRM_BTN = "確定"
...
L.EAM_OPT_CAT_LAYOUT = "設定 (Settings)"
...
L.EAM_RESOURCE_TAB_DISPLAY = "顯示與模式"
L.EAM_RESOURCE_TAB_SIZING = "條形與尺寸"
L.EAM_RESOURCE_TAB_POSITION = "位置與錨點"
L.EAM_RESOURCE_TAB_TEXT = "數值與文字"
...
L.EAM_STAT_GLIDE_ONLY_ICON = "僅滑翔顯示"
L.EAM_STAT_GLIDE_ONLY_ICON_TIP = "僅在御空術/飛龍滑翔狀態 (isGliding == true) 時才顯示此圖示監控，未滑翔時自動隱藏。"
...
-- Next-Gen Group & Catalog Presets (zhTW)
L.EAM_OPT_CAT_GROUP = "★ 群組分類與標籤管理 (Group Management)"
L.EAM_GROUP_OPEN = "★ 群組分類與標籤管理 (Group Management)"
L.EAM_OPT_CAT_CATALOG = "★ 全量法術庫與智慧預設 (Spell Catalog)"
L.EAM_CATALOG_OPEN = "★ 全量法術庫與智慧預設 (Spell Catalog)"
L.GROUP_BURST = "主要爆發"
L.GROUP_DEFENSIVE = "關鍵減傷"
L.GROUP_CC = "控場打斷"
L.GROUP_GROUND = "地面效果"
L.EAM_GROUP_MANAGER_TITLE = "★ 群組分類與標籤管理"
L.EAM_GROUP_MANAGER_SUBTITLE = "管理戰術分類與自訂標籤群組，支援多對多法術複選與情境過濾"
L.EAM_GROUP_NAME_LABEL = "群組名稱:"
L.EAM_GROUP_ENABLE_ALL = "啟用此群組"
L.EAM_GROUP_IN_COMBAT_ONLY = "僅戰鬥中顯示"
L.EAM_GROUP_SPELLS_HEADER = "納入此群組的法術清單 (可複選)："
L.EAM_GROUP_ADD_CUSTOM = "+ 新增群組"
L.EAM_GROUP_DELETE = "- 刪除群組"
L.EAM_NEW_GROUP_DEFAULT_NAME = "自訂群組"
L.EAM_GROUP_COMBAT_BLOCKED = "戰鬥中不開啟群組管理設定。"
L.EAM_CATALOG_TREE_TITLE = "★ 全量法術庫與智慧預設"
L.EAM_CATALOG_TREE_SUBTITLE = "以階層樹狀檢視全職業核心技能，支援三態勾選、戰術分類與依天賦智慧同步"
L.EAM_SEARCH_LABEL = "搜尋:"
L.EAM_AUTO_SYNC_TALENTS = "依當前天賦智慧勾選"
L.EAM_TALENT_SYNC_SUCCESS = "已成功依照當前天賦自動同步核心技能！"
L.EAM_TOGGLE_ALL = "展開/收合"
L.EAM_CATALOG_COMBAT_BLOCKED = "戰鬥中不開啟法術庫勾選面板。"

L.EAM_GROUP_ASSIGN_LABEL = "所屬群組 (可複選):"
L.EAM_GROUP_NONE = "(未指定群組)"
L.EAM_GROUP_SELECTED_COUNT = "已選 %d 個群組"
L.EAM_CATALOG_TARGET_MODULE = "目標模組清單:"
L.EAM_CATALOG_MOD_COOLDOWNS = "技能冷卻"
L.EAM_CATALOG_MOD_PLAYER_AURAS = "自身光環"
L.EAM_CATALOG_MOD_TARGET_AURAS = "目標光環"
L.EAM_CATALOG_MOD_SPECIAL_AURAS = "特殊光環"
L.EAM_CATALOG_MOD_GROUND = "地面效果"



-- Cooldown Reordering and Pre-rendering Placeholders
L.EAM_OPT_COOLDOWN_PRERENDER = "冷卻預渲染佔位 (未使用灰色遮罩)"
L.EAM_OPT_COOLDOWN_PRERENDER_TIP = "在脫戰狀態下預先建立並排列冷卻圖示槽位。尚未進入冷卻的技能以暗色灰階圖示佔位顯示，徹底解決戰鬥中首次施放因戰鬥鎖定無法排版渲染的問題。"
...
L.EAM_OPT_TIMER_COLOR_TITLE = "倒數文字變色 (Color Curve)"
L.EAM_OPT_TIMER_COLOR_ENABLE = "啟用剩餘秒數動態變色"
L.EAM_OPT_TIMER_COLOR_STAGE1 = "緊急警戒 (<= 秒數):"
L.EAM_OPT_TIMER_COLOR_STAGE2 = "預警提示 (<= 秒數):"
L.EAM_OPT_TIMER_COLOR_NORMAL = "正常倒數文字顏色:"
L.EAM_OPT_TIMER_COLOR_DESC = "透過 12.0.7+ 原生 SetTextColorCurve 由 C 核心硬體級驅動，零 GC 零延遲。"

L.EAM_OPT_RESOURCE_DYNAMIC_COLOR = "資源條動態色彩曲線"
L.EAM_OPT_PROGRESS_CURVE_TITLE = "冷卻進度曲線模式"
L.EAM_OPT_PROGRESS_CURVE_LINEAR = "線性均勻 (Linear)"
L.EAM_OPT_PROGRESS_CURVE_CUBIC = "三次加速衝刺 (Cubic)"
L.EAM_OPT_PROGRESS_CURVE_COSINE = "餘弦平滑過渡 (Cosine)"
L.EAM_OPT_LOW_HEALTH_FLASH = "啟用瀕死動態呼吸紅框"
L.EAM_OPT_SLIDER_LOW_HEALTH = "瀕死危急閾值 (Low Health)"

L.EAM_OPT_AURA_STACK_BAR = "啟用光環分段層數條"
L.EAM_OPT_MIN_APPLICATIONS = "最低顯示層數門檻 (minApplications)"
L.EAM_OPT_OVERDRIVE_GLOW = "啟用滿層過曝炫光 (ADD Overdrive)"

L.EAM_TAB_GENERAL = "一般設定"
L.EAM_TAB_LAYOUT = "框架排版"
L.EAM_TAB_TEXT = "字型與文字"
L.EAM_TAB_COOLDOWN = "冷卻與充能"
L.EAM_TAB_GAUGES = "充能與光圈"
L.EAM_TAB_EFFECTS = "視覺與警示"

-- Preview Panel & Stat Tabs (zhTW)
L.EAM_PREVIEW_TITLE = "★ 即時效果預覽 (Live Preview)"
L.EAM_PREVIEW_BTN = "效果預覽"
L.EAM_PREVIEW_TAB_ALERT = "告警圖示"
L.EAM_PREVIEW_TAB_RESOURCE = "職業資源"
L.EAM_PREVIEW_TAB_STAT = "角色屬性"
L.EAM_PREVIEW_SAMPLE_SPELL = "烈焰震擊 (Flame Shock)"
L.EAM_PREVIEW_SIM_TIME = "模擬剩餘秒數 (測試文字變色):"
L.EAM_PREVIEW_SIM_PROC = "模擬金色觸發發光 (Proc Glow)"
L.EAM_PREVIEW_SIM_PANDEMIC = "模擬 DoT 傳染期 (Pandemic)"
L.EAM_PREVIEW_HINT = "拖曳滑桿可測試低於門檻時的自動紅字/黃字變色曲線效果。"
L.EAM_PREVIEW_SAMPLE_POWER = "能量 (Energy)"
L.EAM_PREVIEW_SIM_POWER = "模擬資源充能百分比:"
L.EAM_PREVIEW_SAMPLE_STAT = "致命"
L.EAM_PREVIEW_STAT_HINT = "此處即時連動屬性面板中當前選中屬性之圖示、字型大小、小數位數與警戒邊框。"

L.EAM_STAT_TAB_DISPLAY = "顯示與圖示"
L.EAM_STAT_TAB_FONTS = "字型與格式"
L.EAM_STAT_TAB_THRESHOLDS = "警戒門檻"
L.EAM_STAT_TAB_POSITION = "位置與錨點"
L.EAM_STAT_THRESH_DESC = "當屬性數值超出以下門檻時，圖示外框將呈現深紅高亮閃爍警戒："
