...
L.EAM_OPT_MINIMAP_MCLICK = "中鍵 / Shift+點擊: 重置主視窗至螢幕中央"
...
L.EAM_SLASH_HELP_RESET = "/eam reset (或 /eam center / resetpos) - 將主視窗重置回螢幕中央"
L.EAM_SLASH_RESET_POS_SUCCESS = "已將 EAM 主視窗重置回螢幕中央。"
...
L.EAM_OPT_CAT_STAT = "★ 角色屬性與吸收量監控 (Player Stats)"
L.EAM_STAT_OPEN = "★ 角色屬性與吸收量監控 (Player Stats)"
L.EAM_STAT_PANEL_TITLE = "★ 角色屬性與吸收量監控 (Player Stats & Absorbs)"
L.EAM_MODULE_PLAYER_STAT = "角色屬性與吸收量監控"
L.EAM_FRAME_PLAYER_STAT = "EAM - 角色屬性與吸收量框架"
L.EAM_STAT_ENABLE = "啟用此屬性監控"
L.EAM_STAT_SHOW_ICON = "顯示圖示"
L.EAM_STAT_SHOW_STATUSBAR = "進度條"
L.EAM_STAT_ICON_SIZE = "圖示大小 (Icon Size)"
L.EAM_STAT_FONT_VALUE = "數值字型大小"
L.EAM_STAT_FONT_LABEL = "名稱字型大小"
L.EAM_STAT_CUSTOM_LABEL = "名稱替代文字 (自訂):"
L.EAM_STAT_DECIMALS = "小數位數 (0 ~ 2):"
L.EAM_STAT_SHORT_NUMBER = "大數值簡寫 (k/M)"
L.EAM_STAT_MIN_THRESH = "低於此值紅框警戒:"
L.EAM_STAT_MAX_THRESH = "高於此值紅框警戒:"
L.EAM_STAT_MOVE_BTN = "移動屬性框架"
L.EAM_STAT_SAVED = "已儲存 [%s] 屬性監控設定。"
L.EAM_STAT_COMBAT_BLOCKED = "戰鬥中不開啟屬性監控設定面板。"
...
L.EAM_STAT_VERSATILITY = "臨機應變"
L.EAM_STAT_AVOIDANCE = "閃避"
L.EAM_STAT_LEECH = "汲取"
L.EAM_STAT_SPEED_RATING = "速度 (屬性)"
L.EAM_STAT_RUN_SPEED = "跑速"
L.EAM_STAT_SWIM_SPEED = "泳速"
L.EAM_STAT_FLIGHT_SPEED = "飛速"
L.EAM_STAT_SKYRIDING_SPEED = "飛龍模式飛速"
L.EAM_STAT_TOTAL_ABSORB = "總吸收盾量"
L.EAM_STAT_HEAL_ABSORB = "治療吸收量"
L.EAM_STAT_ARMOR = "護甲值"
L.EAM_OPT_CUSTOM_ICON_LABEL = "自訂替代圖示 (代碼或材質路徑):"
L.EAM_OPT_CUSTOM_ICON_HINT = "可在 WoW.tools / Wago Tools 查詢圖示代碼與路徑:"
L.EAM_WEAPON_ENCHANT_MH = "主手武器附魔"
L.EAM_WEAPON_ENCHANT_OH = "副手武器附魔"
L.EAM_OPT_ENABLE_WEAPON_ENCHANT = "啟用武器暫時附魔提示"
L.EAM_OPT_PET_AURA_TAG = "[寵物]"
L.EAM_OPT_SOUND_NONE = "無 (靜音)"
L.EAM_OPT_SOUND_ALARM1 = "警報 1"
L.EAM_OPT_SOUND_ALARM2 = "警報 2"
L.EAM_OPT_SOUND_BELL = "鈴聲"
L.EAM_OPT_SOUND_DRUM = "戰鼓"
L.EAM_OPT_SOUND_WHISTLE = "哨聲"
L.EAM_OPT_BAR_DEFAULT = "暴雪經典狀態條"
L.EAM_OPT_BAR_FLAT = "扁平純色材質"
L.EAM_OPT_BAR_SMOOTH = "平滑漸層材質"
L.EAM_OPT_RADIAL_GAUGE = "啟用 12.1 原生圓形光環倒數光圈"
L.EAM_STAT_VALUE_PLACEMENT = "無圖示時數值位置:"
L.EAM_STAT_VAL_TOP = "上方 (Top)"
L.EAM_STAT_VAL_BOTTOM = "下方 (Bottom)"
L.EAM_STAT_VAL_LEFT = "左側 (Left)"
L.EAM_STAT_ENABLE_ALL = "全選監控"
L.EAM_STAT_DISABLE_ALL = "全部停用"
L.EAM_STAT_GROW_DIR = "整體排列方向:"
L.EAM_STAT_DIR_RIGHT = "向右 (Right)"
L.EAM_STAT_DIR_LEFT = "向左 (Left)"
L.EAM_STAT_DIR_UP = "向上 (Up)"
L.EAM_STAT_DIR_DOWN = "向下 (Down)"
L.EAM_STAT_USE_CUSTOM_POS = "啟用此項獨立位置 (可自由拖曳)"
L.EAM_STAT_OFFSET_X = "水平位置 (X 偏移)"
L.EAM_STAT_OFFSET_Y = "垂直位置 (Y 偏移)"
L.EAM_STAT_MOVE_SINGLE_BTN = "移動此單項"
L.EAM_STAT_MOVE_ALL_BTN = "移動所有屬性"
L.EAM_STAT_POS_SAVED = "[%s] 獨立位置已儲存: X: %.1f, Y: %.1f"
end)
