...
L.EAM_OPT_POS_AND_POWER_BTN = "설정"
...
L.EAM_OPT_ALLOW_ESC = "ESC로 경고 아이콘 숨기기"
L.EAM_OPT_ALLOW_ESC_TIP = "게임 중 ESC 키를 누르면 쿨다운 사전 렌더링을 손상시키지 않고 모든 경고 아이콘을 숨깁니다. 전투에 들어가거나 새 경고 발생 시 자동 복원됩니다."
...
L.EAM_OPT_SWIPE_COLOR = "음영 색상"
L.EAM_OPT_SWIPE_COLOR_TIP = "색상 선택기를 열어 오라 및 재사용 대기시간 아이콘의 부채꼴 음영 마스크 색상을 사용자 지정합니다 (기본값 검은색)"
...
L.EAM_OPT_CONFIRM_NON_CLASS_SPELL = "이 주문 ID는 현재 직업 전용이 아닐 수 있습니다. 그래도 추가하시겠습니까?"
L.EAM_OPT_CONFIRM_TITLE = "타직업 주문 추가 확인"
L.EAM_OPT_CONFIRM_BTN = "확인"
L.EAM_OPT_CANCEL_BTN = "취소"
...
L.EAM_OPT_CAT_LAYOUT = "설정 (Settings)"
...
L.EAM_RESOURCE_TAB_DISPLAY = "표시 및 모드"
L.EAM_RESOURCE_TAB_SIZING = "바 및 치수"
L.EAM_RESOURCE_TAB_POSITION = "위치 및 기준점"
L.EAM_RESOURCE_TAB_TEXT = "수치 및 텍스트"
...
L.EAM_STAT_GLIDE_ONLY_ICON = "활공 시 표시"
L.EAM_STAT_GLIDE_ONLY_ICON_TIP = "하늘비행/활공 상태(isGliding == true)일 때만 이 아이콘을 화면에 표시하고 지상에서는 자동으로 숨깁니다."
...
L.EAM_OPT_TIMER_COLOR_TITLE = "타이머 문자 색상 곡선 (Color Curve)"
L.EAM_OPT_TIMER_COLOR_ENABLE = "남은 시간별 동적 색상 변경 사용"
L.EAM_OPT_TIMER_COLOR_STAGE1 = "긴급 경고 (<= 초):"
L.EAM_OPT_TIMER_COLOR_STAGE2 = "사전 경고 (<= 초):"
L.EAM_OPT_TIMER_COLOR_NORMAL = "일반 타이머 색상:"
L.EAM_OPT_TIMER_COLOR_DESC = "12.0.7+ 기본 SetTextColorCurve를 통해 C 레벨에서 구동되며, GC 및 지연 시간이 없습니다."

L.EAM_OPT_RESOURCE_DYNAMIC_COLOR = "자원 바 동적 색상 곡선"
L.EAM_OPT_PROGRESS_CURVE_TITLE = "재사용 대기시간 진행 곡선 모드"
L.EAM_OPT_PROGRESS_CURVE_LINEAR = "선형 균등 (Linear)"
L.EAM_OPT_PROGRESS_CURVE_CUBIC = "3차 가속 스퍼트 (Cubic)"
L.EAM_OPT_PROGRESS_CURVE_COSINE = "코사인 부드러운 전환 (Cosine)"
L.EAM_OPT_LOW_HEALTH_FLASH = "생명력 위기 동적 펄스 테두리 사용"
L.EAM_OPT_SLIDER_LOW_HEALTH = "생명력 위기 임계값 (Low Health)"

L.EAM_OPT_AURA_STACK_BAR = "오라 분할 중첩 바 활성화"
L.EAM_OPT_MIN_APPLICATIONS = "최소 표시 중첩 임계값 (minApplications)"
L.EAM_OPT_OVERDRIVE_GLOW = "최대 중첩 오버드라이브 발광 활성화 (ADD)"

L.EAM_TAB_GENERAL = "일반 설정"
L.EAM_TAB_LAYOUT = "프레임 배치"
L.EAM_TAB_TEXT = "글꼴 및 텍스트"
L.EAM_TAB_COOLDOWN = "대기시간 및 충전"
L.EAM_TAB_GAUGES = "충전 및 게이지"
L.EAM_TAB_EFFECTS = "시각 효과 및 경고"

-- Preview Panel & Stat Tabs (koKR)
L.EAM_PREVIEW_TITLE = "★ 실시간 효과 미리보기 (Live Preview)"
L.EAM_PREVIEW_BTN = "효과 미리보기"
L.EAM_PREVIEW_TAB_ALERT = "경고 아이콘"
L.EAM_PREVIEW_TAB_RESOURCE = "직업 자원"
L.EAM_PREVIEW_TAB_STAT = "캐릭터 속성"
L.EAM_PREVIEW_SAMPLE_SPELL = "화염 충격 (Flame Shock)"
L.EAM_PREVIEW_SIM_TIME = "남은 시간 시뮬레이션 (문자 색상 변경 테스트):"
L.EAM_PREVIEW_SIM_PROC = "황금빛 발동 발광 시뮬레이션 (Proc Glow)"
L.EAM_PREVIEW_SIM_PANDEMIC = "지속 피해 갱신 구간 시뮬레이션 (Pandemic)"
L.EAM_PREVIEW_HINT = "슬라이더를 드래그하여 임계값 미만 시 동적 빨강/노랑 텍스트 색상 곡선 효과를 테스트합니다."
L.EAM_PREVIEW_SAMPLE_POWER = "기력 (Energy)"
L.EAM_PREVIEW_SIM_POWER = "자원 충전 백분율 시뮬레이션:"
L.EAM_PREVIEW_SAMPLE_STAT = "치명타"
L.EAM_PREVIEW_STAT_HINT = "속성 패널에서 현재 선택된 속성의 아이콘, 글꼴 크기, 소수점 자릿수 및 경고 테두리를 실시간으로 반영합니다."

L.EAM_STAT_TAB_DISPLAY = "표시 및 아이콘"
L.EAM_STAT_TAB_FONTS = "글꼴 및 서식"
L.EAM_STAT_TAB_THRESHOLDS = "경고 임계값"
L.EAM_STAT_TAB_POSITION = "위치 및 앵커"
L.EAM_STAT_THRESH_DESC = "속성 값이 다음 임계값을 초과하면 아이콘 테두리가 진한 빨간색으로 깜박이며 경고합니다:"
