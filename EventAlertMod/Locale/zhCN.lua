...
L.EAM_OPT_POS_AND_POWER_BTN = "设置"
...
L.EAM_OPT_ALLOW_ESC = "ESC 关闭提示图标"
L.EAM_OPT_ALLOW_ESC_TIP = "在游戏中按 ESC 键可快速隐藏画面中央的所有提醒图标（采用无损纯透明度，不破坏冷却预渲染，进入战斗或触发新提示时自动恢复）。"
...
L.EAM_OPT_SWIPE_COLOR = "扇形颜色"
L.EAM_OPT_SWIPE_COLOR_TIP = "点击打开调色盘，自定义光环与冷却图标倒数扇形阴影遮罩的颜色（默认经典黑色阴影）"
...
L.EAM_OPT_CONFIRM_NON_CLASS_SPELL = "这个 SPELL ID 可能不是你的职业专属，你仍要加入吗？"
L.EAM_OPT_CONFIRM_TITLE = "跨职业法术确认"
L.EAM_OPT_CONFIRM_BTN = "确定"
L.EAM_OPT_CANCEL_BTN = "取消"
...
L.EAM_OPT_CAT_LAYOUT = "设置 (Settings)"
...
L.EAM_RESOURCE_TAB_DISPLAY = "显示与模式"
L.EAM_RESOURCE_TAB_SIZING = "条形与尺寸"
L.EAM_RESOURCE_TAB_POSITION = "位置与锚点"
L.EAM_RESOURCE_TAB_TEXT = "数值与文字"
...
L.EAM_STAT_GLIDE_ONLY_ICON = "仅滑翔显示"
L.EAM_STAT_GLIDE_ONLY_ICON_TIP = "仅在御空术/飞龙滑翔状态 (isGliding == true) 时才在画面上显示此图标监控，未滑翔时自动隐藏。"
...
L.EAM_WEAPON_ENCHANT_MH = "主手武器附魔"
L.EAM_WEAPON_ENCHANT_OH = "副手武器附魔"
L.EAM_OPT_ENABLE_WEAPON_ENCHANT = "启用武器临时附魔提示"
L.EAM_OPT_PET_AURA_TAG = "[宠物]"
L.EAM_OPT_SOUND_NONE = "无 (静音)"
L.EAM_OPT_SOUND_ALARM1 = "警报 1"
L.EAM_OPT_SOUND_ALARM2 = "警报 2"
L.EAM_OPT_SOUND_BELL = "铃声"
L.EAM_OPT_SOUND_DRUM = "战鼓"
L.EAM_OPT_SOUND_WHISTLE = "哨声"
L.EAM_OPT_BAR_DEFAULT = "暴雪经典状态条"
L.EAM_OPT_BAR_FLAT = "扁平纯色材质"
L.EAM_OPT_BAR_SMOOTH = "平滑渐变材质"
L.EAM_OPT_RADIAL_GAUGE = "启用 12.1 原生圆形光环倒数光圈"
L.EAM_STAT_VALUE_PLACEMENT = "无图标时数值位置:"
L.EAM_STAT_VAL_TOP = "上方 (Top)"
L.EAM_STAT_VAL_BOTTOM = "下方 (Bottom)"
L.EAM_STAT_VAL_LEFT = "左侧 (Left)"
L.EAM_STAT_ENABLE_ALL = "全选监控"
L.EAM_STAT_DISABLE_ALL = "全部停用"
L.EAM_STAT_GROW_DIR = "整体排列方向:"
L.EAM_STAT_DIR_RIGHT = "向右 (Right)"
L.EAM_STAT_DIR_LEFT = "向左 (Left)"
L.EAM_STAT_DIR_UP = "向上 (Up)"
L.EAM_STAT_DIR_DOWN = "向下 (Down)"
L.EAM_STAT_USE_CUSTOM_POS = "启用此项独立位置 (可自由拖曳)"
L.EAM_STAT_OFFSET_X = "水平位置 (X 偏移)"
L.EAM_STAT_OFFSET_Y = "垂直位置 (Y 偏移)"
L.EAM_STAT_MOVE_SINGLE_BTN = "移动此单项"
L.EAM_STAT_MOVE_ALL_BTN = "移动所有属性"
L.EAM_STAT_POS_SAVED = "[%s] 独立位置已保存: X: %.1f, Y: %.1f"

-- Next-Gen Group & Catalog Presets (zhCN)
L.EAM_OPT_CAT_GROUP = "★ 群组分类与标签管理 (Group Management)"
L.EAM_GROUP_OPEN = "★ 群组分类与标签管理 (Group Management)"
L.EAM_OPT_CAT_CATALOG = "★ 全量法术库与智能预设 (Spell Catalog)"
L.EAM_CATALOG_OPEN = "★ 全量法术库与智能预设 (Spell Catalog)"
L.GROUP_BURST = "主要爆发"
L.GROUP_DEFENSIVE = "关键减伤"
L.GROUP_CC = "控场打断"
L.GROUP_GROUND = "地面效果"
L.EAM_GROUP_MANAGER_TITLE = "★ 群组分类与标签管理"
L.EAM_GROUP_MANAGER_SUBTITLE = "管理战术分类与自定义标签群组，支持多对多法术复选与情境过滤"
L.EAM_GROUP_NAME_LABEL = "群组名称:"
L.EAM_GROUP_ENABLE_ALL = "启用此群组"
L.EAM_GROUP_IN_COMBAT_ONLY = "仅战斗中显示"
L.EAM_GROUP_SPELLS_HEADER = "📋 纳入此群组的法术清单 (可复选)："
L.EAM_GROUP_ADD_CUSTOM = "+ 新增群组"
L.EAM_GROUP_DELETE = "- 删除群组"
L.EAM_NEW_GROUP_DEFAULT_NAME = "自定义群组"
L.EAM_GROUP_COMBAT_BLOCKED = "战斗中不开启群组管理设置。"
L.EAM_CATALOG_TREE_TITLE = "★ 全量法术库与智能预设"
L.EAM_CATALOG_TREE_SUBTITLE = "以阶层树状检视全职业核心技能，支持三态勾选、战术分类与依天赋智能同步"
L.EAM_SEARCH_LABEL = "搜索:"
L.EAM_AUTO_SYNC_TALENTS = "依当前天赋智能勾选"
L.EAM_TALENT_SYNC_SUCCESS = "已成功依照当前天赋自动同步核心技能！"
L.EAM_TOGGLE_ALL = "展开/收起"
L.EAM_CATALOG_COMBAT_BLOCKED = "战斗中不开启法术库勾选面板。"

L.EAM_GROUP_ASSIGN_LABEL = "所属群组 (可多选):"
L.EAM_GROUP_NONE = "(未指定群组)"
L.EAM_GROUP_SELECTED_COUNT = "已选 %d 个群组"
L.EAM_CATALOG_TARGET_MODULE = "目标模块清单:"
L.EAM_CATALOG_MOD_COOLDOWNS = "技能冷却"
L.EAM_CATALOG_MOD_PLAYER_AURAS = "自身光环"
L.EAM_CATALOG_MOD_TARGET_AURAS = "目标光环"
...
L.EAM_OPT_TIMER_COLOR_TITLE = "倒计时文字变色 (Color Curve)"
L.EAM_OPT_TIMER_COLOR_ENABLE = "启用剩余秒数动态变色"
L.EAM_OPT_TIMER_COLOR_STAGE1 = "紧急警戒 (<= 秒数):"
L.EAM_OPT_TIMER_COLOR_STAGE2 = "预警提示 (<= 秒数):"
L.EAM_OPT_TIMER_COLOR_NORMAL = "正常倒计时文字颜色:"
L.EAM_OPT_TIMER_COLOR_DESC = "通过 12.0.7+ 原生 SetTextColorCurve 由 C 核心硬件级驱动，零 GC 零延迟。"

L.EAM_OPT_RESOURCE_DYNAMIC_COLOR = "资源条动态色彩曲线"
L.EAM_OPT_PROGRESS_CURVE_TITLE = "冷却进度曲线模式"
L.EAM_OPT_PROGRESS_CURVE_LINEAR = "线性均匀 (Linear)"
L.EAM_OPT_PROGRESS_CURVE_CUBIC = "三次加速冲刺 (Cubic)"
L.EAM_OPT_PROGRESS_CURVE_COSINE = "余弦平滑过渡 (Cosine)"
L.EAM_OPT_LOW_HEALTH_FLASH = "启用濒死动态呼吸红框"
L.EAM_OPT_SLIDER_LOW_HEALTH = "濒死危急阈值 (Low Health)"

L.EAM_OPT_AURA_STACK_BAR = "启用光环分段层数条"
L.EAM_OPT_MIN_APPLICATIONS = "最低显示层数门槛 (minApplications)"
L.EAM_OPT_OVERDRIVE_GLOW = "启用满层过曝炫光 (ADD Overdrive)"

L.EAM_TAB_GENERAL = "常规设置"
L.EAM_TAB_LAYOUT = "框架排版"
L.EAM_TAB_TEXT = "字体与文字"
L.EAM_TAB_COOLDOWN = "冷却与充能"
L.EAM_TAB_GAUGES = "充能与光圈"
L.EAM_TAB_EFFECTS = "视觉与警示"

-- Preview Panel & Stat Tabs (zhCN)
L.EAM_PREVIEW_TITLE = "★ 即时效果预览 (Live Preview)"
L.EAM_PREVIEW_BTN = "效果预览"
L.EAM_PREVIEW_TAB_ALERT = "告警图标"
L.EAM_PREVIEW_TAB_RESOURCE = "职业资源"
L.EAM_PREVIEW_TAB_STAT = "角色属性"
L.EAM_PREVIEW_SAMPLE_SPELL = "烈焰震击 (Flame Shock)"
L.EAM_PREVIEW_SIM_TIME = "模拟剩余秒数 (测试文字变色):"
L.EAM_PREVIEW_SIM_PROC = "模拟金色触发发光 (Proc Glow)"
L.EAM_PREVIEW_SIM_PANDEMIC = "模拟 DoT 传染期 (Pandemic)"
L.EAM_PREVIEW_HINT = "拖曳滑块可测试低于阈值时的自动红字/黄字变色曲线效果。"
L.EAM_PREVIEW_SAMPLE_POWER = "能量 (Energy)"
L.EAM_PREVIEW_SIM_POWER = "模拟资源充能百分比:"
L.EAM_PREVIEW_SAMPLE_STAT = "暴击"
L.EAM_PREVIEW_STAT_HINT = "此处即时联动属性面板中当前选中属性之图标、字体大小、小数位数与警戒边框。"

L.EAM_STAT_TAB_DISPLAY = "显示与图标"
L.EAM_STAT_TAB_FONTS = "字体与格式"
L.EAM_STAT_TAB_THRESHOLDS = "警戒阈值"
L.EAM_STAT_TAB_POSITION = "位置与锚点"
L.EAM_STAT_THRESH_DESC = "当属性数值超出以下阈值时，图标外框将呈现深红高亮闪烁警戒："
