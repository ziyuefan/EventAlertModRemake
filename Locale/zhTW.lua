...
L.EAM_LIVE_COMPLETE_READY = "JSON 已完成；直接複製即為最新。若要從 WTF 匯入，請由玩家再輸入 /reload 或正常登出保存。"
L.EAM_LIVE_COPY = "複製實機 JSON"
L.EAM_LIVE_COPIED = "JSON 已複製；回報時請連同 PTR／XPTR／正式服標籤提供。"
