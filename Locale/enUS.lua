...
L.EAM_FLOW_BUTTON_COPY = "Copy Dev Report"
...
L.EAM_FLOW_STATUS_COPIED = "Report copied for developer feedback."
...
L.EAM_LIVE_COMPLETE_READY = "JSON is ready and can be copied now. To import it from WTF, the player must /reload again or log out normally to save it."
L.EAM_LIVE_COPY = "Copy Live JSON"
L.EAM_LIVE_COPIED = "JSON copied. Include the PTR, XPTR, or Retail label when reporting it."
