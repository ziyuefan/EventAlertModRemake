...
def main():
    ...
    governance_root = os.path.dirname(tools_dir)
    project_root = os.path.dirname(governance_root)
    docs_dir = os.path.join(governance_root, "Docs")
    dest_dir = os.path.join(governance_root, "docs_html")
    ...
    root_mds = [
        os.path.join(governance_root, "AGENTS.md"),
