...
local function createGenericFrame(frameType, frameName)
    ...
    function frame:SetFormattedText(formatString, ...)
        self.text = string.format(formatString, ...)
    end
    ...
    function frame:SetFocus()        Mock.keyboardFocus = self
    end
...
function Mock.install(interfaceVersion)
    ...
    Mock.specializationIndex = 1
    Mock.specializationID = 65
    ...
    GetSpecialization = function()
        return Mock.specializationIndex
    end
    GetSpecializationInfo = function()
        return Mock.specializationID
    end
    ...
    C_Secrets = {
        ...
        GetPowerTypeSecrecy = function(powerType)
            if Mock.secretPowerTypes[powerType] or Mock.secretPowerMaxTypes[powerType] then
                return Enum.SecrecyLevel.ContextuallySecret
            end
            return Enum.SecrecyLevel.NeverSecret
        end,
    }
...
function Mock.setUnitPowerScenario(classToken, values, maximums, secretTypes, secretMaxTypes, specializationID)
...
function Mock.setSpecialization(specializationID, specializationIndex)
    Mock.specializationID = specializationID
    Mock.specializationIndex = specializationIndex or 1
end

function Mock.setForegroundPower(powerType, powerToken)
    Mock.unitPowerType = powerType
    Mock.unitPowerToken = powerToken
end
